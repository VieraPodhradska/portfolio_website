                ...
                <div className='flex flex-col max-lg:items-center max-lg:text-center items-start text-left z-10 lg:flex-1'>
                    <div className='flex flex-col'>
                        ...
                        <div className='flex flex-col max-lg:items-center'>
                            <h2 className='text-3xl w-fit lg:text-4xl font-medium lg:font-extrabold mb-3 before:content-o_mne relative before:absolute before:opacity-40 before:-top-[4rem] before:-right-72 before:max-xl:scale-75 before:max-xl:-right-60 before:max-md:-right-48 before:max-sm:-right-32 text-quaternary space-y-1'>
                        ...
                        <p className='mb-12 font-bold '>Expert pre komplexné finančné služby</p>
