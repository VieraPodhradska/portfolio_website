    ...
    <footer className='bg-primary py-12 relative overflow-hidden'>
        <div className='container mx-auto'>
            <div className='flex flex-col lg:flex-row space-y-6 lg:space-y-0 items-center justify-between'>
                ...
                <div className=''>
                    <img className='absolute bottom-12 left-52 max-lg:bottom-48 max-lg:left-10 max-sm:bottom-56 max-sm:-left-4 select-none h-96 z-10' draggable="false" src={WuObjectGR} />
                </div>

                <div className=''>
                    <img className='absolute bottom-8 left-40 max-lg:bottom-48 max-lg:left-0 max-sm:-left-20 select-none h-96 z-0' draggable="false" src={WuObjectDRR} />
                </div>

                <div className=''>
                    <img className='absolute top-16 left-64 max-lg:left-10 max-sm:-left-4 max-sm:top-28 select-none h-96 z-0' draggable="false" src={WuObjectRRH} />
                </div>
                ...
                <div className='flex max-md:order-2 space-x-1 items-center justify-center z-10'>
                    {social.map((item, index) => {
                        ...
                        return <a href={href} key={index} className='text-accent text-lg p-4' target='_blank'>{icon}</a>
                    })}
                </div>
